...
public class ResetCommandHandler(DiscordSocketClient client, SlashCommandManager commandManager, ILogger<ResetCommandHandler> logger) : SlashCommandHandler(client, commandManager, logger)
{
